...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&color=58A6FF&center=true&vCenter=true&width=580&lines=Building+AI+at+the+Edge+%F0%9F%9A%80;Embedded+Linux+Engineer+%F0%9F%90%A7;Computer+Vision+%2B+YOLO+%2B+OCR;Raspberry+Pi+%2F+RockPi+Enthusiast)](https://git.io/typing-svg)
...
> Embedded Linux & Computer Vision engineer focused on deploying **AI-powered vision systems** on edge devices.

I build real-world pipelines that run **fast, lean, and reliable** — from raw camera input to intelligent output — directly on edge hardware like **Raspberry Pi** and **RockPi**.
...
| Domain | Details |
|---|---|
| 🖥️ **Embedded Linux** | SBC development, systemd services, networking |
| 🤖 **Edge AI** | Deploy CV models on constrained hardware |
| 📸 **Computer Vision** | OpenCV pipelines, event-triggered recording |
| 🌐 **Backend** | Lightweight REST APIs with FastAPI |
| 🏭 **Use Cases** | Industrial inspection & monitoring |
...
⭐ Always building reliable **Embedded AI & Computer Vision** systems at the edge.
